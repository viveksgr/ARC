...
for si = 1:numel(subjects)
    ...
    for vi = 1:nvox
     ...
     beta_val = unmasker( beta_val,Mv);
     beta_sal = unmasker( beta_sal,Mv);
    outdir = fullfile(subdir,'results_searchl');

     write_reshaped_nifty(beta_val,subdir,false,fullfile(subdir,'wm_fullmask.nii'))
     write_reshaped_nifty(beta_sal,subdir,false,fullfile(subdir,'wm_fullmask.nii'))
