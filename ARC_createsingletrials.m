...
if linux_config
    ...
    addpath('C:\Toolboxes\GLMsingle-main\GLMsingle-main\matlab')
    addpath('C:\Toolboxes\fracridge-master\fracridge-master\matlab')
    addpath('C:\Toolboxes\GLMsingle-main\GLMsingle-main\matlab\utilities')
    statpath = fullfile('C:\Data\ARC',sprintf('ARC%02d',s),'single');
    maskpaths = fullfile('C:\Data\NEMO\',sprintf('NEMO_%02d',s),'\imaging\nii\masks');
    datapath = fullfile('E:\Data\NEMO',sprintf('NEMO_%02d',s),'\imaging\nii');
end
